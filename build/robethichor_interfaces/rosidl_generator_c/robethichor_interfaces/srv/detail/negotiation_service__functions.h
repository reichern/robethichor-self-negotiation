...
#ifndef ROBETHICHOR_INTERFACES__SRV__DETAIL__NEGOTIATION_SERVICE__FUNCTIONS_H_
#define ROBETHICHOR_INTERFACES__SRV__DETAIL__NEGOTIATION_SERVICE__FUNCTIONS_H_
...
/// Initialize srv/NegotiationService message.
/**
...
/// Finalize srv/NegotiationService message.
/**
...
/// Create srv/NegotiationService message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * robethichor_interfaces__srv__NegotiationService_Request__init().
...
/// Destroy srv/NegotiationService message.
/**
 * It calls
 * robethichor_interfaces__srv__NegotiationService_Request__fini()
...
/// Check for srv/NegotiationService message equality.
/**
...
/// Copy a srv/NegotiationService message.
/**
...
/// Initialize array of srv/NegotiationService messages.
/**
...
/// Finalize array of srv/NegotiationService messages.
/**
 * It calls
 * robethichor_interfaces__srv__NegotiationService_Request__fini()
...
/// Create array of srv/NegotiationService messages.
/**
 * It allocates the memory for the array and calls
 * robethichor_interfaces__srv__NegotiationService_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/NegotiationService messages.
/**
 * It calls
 * robethichor_interfaces__srv__NegotiationService_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/NegotiationService message array equality.
/**
...
/// Copy an array of srv/NegotiationService messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * robethichor_interfaces__srv__NegotiationService_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_robethichor_interfaces
...
/**
 * It calls
 * robethichor_interfaces__srv__NegotiationService_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_robethichor_interfaces
...
/**
 * It allocates the memory for the array and calls
 * robethichor_interfaces__srv__NegotiationService_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_robethichor_interfaces
...
/**
 * It calls
 * robethichor_interfaces__srv__NegotiationService_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // ROBETHICHOR_INTERFACES__SRV__DETAIL__NEGOTIATION_SERVICE__FUNCTIONS_H_
