...
static const _NegotiationService_Request_type_support_symbol_names_t _NegotiationService_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robethichor_interfaces, srv, NegotiationService_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, robethichor_interfaces, srv, NegotiationService_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, robethichor_interfaces, srv, NegotiationService_Request)() {
  return &::robethichor_interfaces::srv::rosidl_typesupport_c::NegotiationService_Request_message_type_support_handle;
}
...
static const _NegotiationService_Response_type_support_symbol_names_t _NegotiationService_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robethichor_interfaces, srv, NegotiationService_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, robethichor_interfaces, srv, NegotiationService_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, robethichor_interfaces, srv, NegotiationService_Response)() {
  return &::robethichor_interfaces::srv::rosidl_typesupport_c::NegotiationService_Response_message_type_support_handle;
}
...
static const _NegotiationService_type_support_symbol_names_t _NegotiationService_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robethichor_interfaces, srv, NegotiationService)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, robethichor_interfaces, srv, NegotiationService)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, robethichor_interfaces, srv, NegotiationService)() {
  return &::robethichor_interfaces::srv::rosidl_typesupport_c::NegotiationService_service_type_support_handle;
}
